...
public class AutoVacuum extends CommandBase {
  protected final IntakeLeft leftway;
  protected final IntakeRight rightway;
  protected final Arm armSubsystem;
  /** Creates a new AutoVacuum. */
  public AutoVacuum(Arm armSubsystem, IntakeLeft lefteject, IntakeRight righteject) {
  ...
  public boolean isFinished() {
    if (this.armSubsystem.isDoneWithMotionMagic()){
      return true;
    }
    else{
      return false;
