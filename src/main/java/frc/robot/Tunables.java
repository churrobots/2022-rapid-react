...
public final class Tunables {
  ...
  public static final TunableInteger armCruiseVelocityInSensorUnits = new TunableInteger(
      "armCruiseVelocityInSensorUnits", 18000);
  public static final TunableInteger armAccelerationInSensorUnits = new TunableInteger("armAccelerationInSensorUnits",
      8000);

  public static final TunableDouble maxDriveVoltage = new TunableDouble("maxDriveVoltage", 0.83);
  public static final TunableDouble maxDriveAcceleration = new TunableDouble("maxDriveAcceleration", 2.2);
  ...
  public static final TunableInteger armScorePositionSensorCounts = new TunableInteger("armScorePositionSensorCounts",
      500);
  public static final TunableInteger armVacuumPositionSensorCounts = new TunableInteger("armVacuumPositionSensorCounts",
      -43000);
  public static final TunableInteger armDrivingPositionSensorCounts = new TunableInteger(
      "armDrivingPositionSensorCounts", 500);
  public static final TunableInteger armTuckingPositionSensorCounts = new TunableInteger(
      "armTuckingPositionSensorCounts", -17000);
